  ...
  xmlhttp.onreadystatechange=function() {
    if(xmlhttp.readyState == 4 && xmlhttp.status==200) {
      ...
      for(var i = 0; i < titles.length; i++) {
        ...
        document.getElementById("list").innerHTML += '<tr><td id="firstcolum">'+ imageURL + '</td><td id="secondcolum">' + title + '<br/>' + date + "."+ month+ "." + year + " " + time + '<br/>' + "Kesto: " + xmlDuration + " minuuttia <br/> <br/>" + ratingIMG + descriptionImages + '</td>';
      }
    }
  }
}
